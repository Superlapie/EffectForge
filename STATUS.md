...
- **@effectforge/cli** — `validate`, `create`, `inspect`, `pack`, `unpack`, `preset` commands
- **License audit tooling** — Automated dependency license check

## What is partially implemented

- **CLI** — Core project/preset commands only; full commands in Phase 19
- **Desktop / MCP apps** — Package stubs only
- **Inspector** — Particle layers only; other layer kinds and advanced curves in later phases
- **Asset binaries** — Archive and preset formats support `assets/` entries; editor does not yet manage binary assets

## What is not implemented

- Code exporters (Phase 10)
- Post-processing, trails, and all later phases

## What is being worked on next

**Phase 10: Exporters** — See `docs/EXPORTERS.md`
